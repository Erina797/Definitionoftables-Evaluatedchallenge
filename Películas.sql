...
En este desafío validaremos nuestros conocimientos de Definición de tablas. Para lograrlo,
necesitarás aplicar todos los conocimientos adquiridos hasta el momento utilizando de
apoyo el archivo Apoyo Desafío evaluado - Definición de tablas.
...
-- Para el nombre Nombre y Longitud
